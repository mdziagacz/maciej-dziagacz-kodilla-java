...
public class CompanyDaoTestSuite {
    ...
    @Test
    public void testFindCompanyBy3FirstLetters(){
        //Given
        Employee johnSmith = new Employee("John", "Smith");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson");
        Employee lindaKovalsky = new Employee("Linda", "Kovalsky");
        ...
        //When
        List<Company> foundCompanies = companyDao.findCompanyBy3FirstLetters("Dat");

        //Then
        Assert.assertEquals(1, foundCompanies.size());
        Assert.assertEquals("Data Maesters", foundCompanies.get(0).getName());
        try{
